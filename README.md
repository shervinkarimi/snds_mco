...
Le code ci-dessous est écrit en SAS Guide, le logiciel principal utilisé dans l'exploitation du SNDS par la CNAM, particulièrement adapté de grande volumétrie. Si vous souhaitez utiliser R, la CNAM fournit également un guide (dossier : [R Guide utilisateur Rstudio](https://documentation-snds.health-data-hub.fr/snds/cnam/bonnes_pratiques_r/)), mais cela nécessite généralement de passer par un moteur Oracle pour gérer la volumétrie conséquente de ces bases.
